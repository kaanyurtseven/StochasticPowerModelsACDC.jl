...
mpc.convdc = {
	0	1	100	1	1	1.0079	1.1	0.01	1.1	1	1	-58.6274	0	1.103	-50	0.01	0.01	0.01	1	2	1	1	-40	0.887	345	2.885	0.005	-100	50	1	0.9	-60	1	1	0.01	2.885
	0	1	100	1	1	1.0	1.1	0.01	1.1	1	1	21.9013	0	1.103	-50	0.01	0.01	0.01	2	3	1	2	0	0.887	345	2.885	0.007	-100	50	1	0.9	0	1	1	0.01	2.885
	0	1	100	1	1	0.9978	1.1	0.01	1.1	1	1	36.1856	0	1.103	-50	0.01	0.01	0.01	3	5	1	1	5	0.887	345	2.885	0.005	-100	50	1	0.9	35	1	1	0.01	2.885
};

%column_names% c r status λcmax rateB fbusdc rateA l rateC tbusdc 
mpc.branchdc = {
	0	0.052	1	1	100	1	100	0	100	2
	0	0.052	1	1	100	2	100	0	100	3
	0	0.073	1	1	100	1	100	0	100	3
};

%column_names% Vdc λvmax Cdc basekVdc busdc_i grid λvmin Vdcmax Vdcmin Pdc 
mpc.busdc = {
	1	1	0	345	1	1	1	1.1	0.9	0
	1	1	0	345	2	1	1	1.1	0.9	0
	1	1	0	345	3	1	1	1.1	0.9	0
};
